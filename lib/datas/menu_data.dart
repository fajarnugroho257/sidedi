import 'package:sidedi/models/menu_model.dart';

List<MenuModel> menuIcons = [
  MenuModel(title: 'Pengurus', screen: 'pengurus_screen'),
  MenuModel(title: 'Profesi Warga', screen: 'profesi_screen'),
  MenuModel(title: 'Kegiatan / Informasi', screen: 'informasi_screen'),
  MenuModel(title: 'Kartu keluarga', screen: 'kk_screen'),
